...
<article class="post post--condensed" style="height: auto;">
	<div class="post__image">
		<a href="<?= get_permalink($article); ?>">
			<?= get_the_post_thumbnail($article, 'large'); ?>
		</a>
	</div>
	<div class="post__cat">
	...
	<div class="post__meta">
		<h2 class="post__title heading"><a href="<?= get_permalink($article); ?>"><?= get_the_title($article);?></a></h2>
